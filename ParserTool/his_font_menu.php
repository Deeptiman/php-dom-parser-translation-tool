...
<script>
   ...
   <form id="form1" action="his_unicode_converter.php" method="post" target="unicode">
...
<input type="hidden" name="nodir" value="<?php echo $not[sizeof($not)-1];?>"/>
   <input type="hidden" name="sarala" value="Sarala" />
    ...
    <form id="form11" action="his_font_menu.php" method="post">   
    ...
    <form id="form21" action="his_font_menu.php" method="post">   
   ...
   <form id="form2" action="his_unicode_converter.php" method="post" target="unicode">
<input type="hidden" name="exdir" value="<?php echo $ext;?>"/>
<input type="hidden" name="nodir" value="<?php echo $not[sizeof($not)-1];?>"/>
   <input type="hidden" name="akruti" value="Akruti" />
    ...
    <form id="form31" action="his_font_menu.php" method="post">   
   ...
   <form id="form3" action="his_unicode_converter.php" method="post" target="unicode">
<input type="hidden" name="exdir" value="<?php echo $ext;?>"/>
<input type="hidden" name="nodir" value="<?php echo $not[sizeof($not)-1];?>"/>
   <input type="hidden" name="lsodia" value="LSOdia" />
    ...
    <form id="form41" action="his_font_menu.php" method="post">   
   ...
   <form id="form4" action="his_unicode_converter.php" method="post" target="unicode">
<input type="hidden" name="exdir" value="<?php echo $ext;?>"/>
<input type="hidden" name="nodir" value="<?php echo $not[sizeof($not)-1];?>"/>
