...
<p style="margin-left:-8px; margin-top:40px; background-color:#333; color:#FFF; font-family:calibri; font-size:14px; width:200px; height:25px;">
...
<p style="margin-left:-8px; background-color:#C00; color:#FFF; font-family:calibri; font-size:14px; width:200px; height:25px;">
   ...
   C:\wamp\www\Odia\HTML Parser\Result\<?php echo $_POST['fname']; ?></p>
...
?>	
    ...
    <p align="center" style="background-color:#360; color:#FFF; font-family:calibri; font-size:14px; width:200px; height:25px; margin-top:40px; margin-left:170px;">
	
    &nbsp;&nbsp;Conversion Interupted
...
?>
  ...
  <div id="extr" style="font-family:calibri; font-size:15px; margin-left:-2px; margin-top:-25px;"></div>

  <div id="pw" style="font-family:calibri; font-size:15px; margin-left:-2px; margin-top:15px;"></div>

  <div id="cur" style="font-family:calibri; font-size:15px; margin-left:-2px; margin-top:15px;"></div>
...
document.getElementById("rest").innerHTML="<input type='.$button.' value='.$value1.' onclick='.$java.' style='.$background.';'.$color.';'.$font_family.';'.$font_size.';'.$margin_left.';'.$margin_top.'>";
		   ...
		   else if($wt==1)
		   {
				...
				//// Adusting the display , when first directory is being converting into Unicode ////
			
				$margin_top='\"margin-top:55px\"';
			
				echo '<script language="javascript">

				document.getElementById("rest").innerHTML="<p style='.$margin_top.'></p>";
	 ...
	 {		 
		...
		$ex_text_dir=$tdir;	/// Creating Result directory name ///
		...
		echo '<script language="javascript">
			  document.getElementById("extr").innerHTML="'.'<b style='.$margin_left.'>Current Working Directory :  </b>'.$tdir.' ";
		      </script>';
	 ...
	 else if($flog!=1)
	 {
		...
		echo '<script language="javascript">
		document.getElementById("extr").innerHTML="'.'<b style='.$margin_left.'>Current Working Directory :  </b>'.$fdir[$xy].' ";
			  </script>';
	 ...
	 echo '<script language="javascript">
document.getElementById("pw").innerHTML="'.'<b style='.$margin_left.'>Extracting Directory No -  </b> : '.$wt.' , <b>TextFile Name : </b>'.$fn.'";
		   </script>';			
			...
			/// Connecting with the Unicode Converter API to Convert the sum into Unicode ///
				...
				if(file_exists($dir1.$ex_text_dir.'\\'.$fn))
				{
					
					unlink($dir1.$ex_text_dir.'\\'.$fn);
...
/*
	...
	$filex=$uni_dir.'\\'.'UnicodeStatus.txt';
...
$margin_left='\"margin-left:10px;\"';		
	...
	echo '<script language="javascript">
 document.getElementById("cur").innerHTML="'.'<b style='.$margin_left.'> Total Directory Converted to Unicode :  </b>'.$wt.'/'.sizeof($fname).'"
...
?>
	...
	<p  style="background-color:#C00; color:#FFF; margin-left:30px; font-family:calibri; font-size:14px; width:370px; height:25px; margin-top:15px;">
...
?>	 
	...
	<p  align="center" style="color:#333;  font-family:calibri; font-size:20px; width:300px; height:25px; margin-top:50px;">
...
?> 
 ...
 <div align="center">
	...
	<p  align="center" style="color:#333;  font-family:calibri; font-size:20px; width:300px; height:25px; margin-top:60px;">
  &nbsp;&nbsp;No Active Event </p>
